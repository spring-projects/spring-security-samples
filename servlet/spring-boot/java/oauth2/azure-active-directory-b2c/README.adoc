...
Sample project: <<./web-application-2-with-scopes/, web-application-2-with-scopes>>
...
Sample project: <<./web-application-3-with-client-credentials/, web-application-3-with-client-credentials>>
...
Sample project: <<./web-application-4-with-additional-parameters/, web-application-4-with-additional-parameters>>
...
Sample project: <<./resource-server-1-simple-sample/, resource-server-1-simple-sample>>
...
Sample project: <<./resource-server-2-validate-audience/, resource-server-2-validate-audience>>
...
Sample project: <<./resource-server-3-authorize-by-scopes/, resource-server-3-authorize-by-scopes>>
...
Sample project: <<./resource-server-4-authorize-by-app-roles/, resource-server-4-authorize-by-app-roles>>
...
Sample project: <<./resource-server-5-multi-tenant/, resource-server-5-multi-tenant>>
